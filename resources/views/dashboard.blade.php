                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a
                                href="{{action('App\Http\Controllers\usersController@dashboard')}}">Home</a></li>
...
<div class="container-fluid">
    ...
    <div class="row">
        <!-- Column -->
        <div class="col-md-6 col-lg-2 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white"><i class="fa-solid fa-gauge"></i></h1>
                    <h6 class="text-white">Dashboard</h6>
                </div>
            </div>
        </div>
        <!-- Column -->
        <div class="col-md-6 col-lg-4 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-success text-center">
                    ...
                    <h6 class="text-white">
                        Videos
                        <span class="badge">&lpar; 152 &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-warning text-center">
                    <h1 class="font-light text-white">
                        <i class="fas fa fa-thin fa-money-check-dollar"></i>
                    </h1>
                    <h6 class="text-white">
                        Today Purches
                        <span class="badge">&lpar; 500 &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-danger text-center">
                    <h1 class="font-light text-white">
                        <i class="fas fa fa-thin fa-cloud-arrow-up"></i>
                    </h1>
                    <h6 class="text-white">
                        Uploded
                        <span class="badge">&lpar; 2000 &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
            ...
            <div class="card card-hover">
                <div class="box bg-danger text-center">
                    ...
                    <h6 class="text-white">Total Users
                        <span class="badge">&lpar; 4875152K &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-info text-center">
                    <h1 class="font-light text-white">
                        <i class="fas fa fa-thin fa-envelope-open-text"></i>
                    </h1>
                    <h6 class="text-white">
                        Messages
                        <span class="badge">&lpar; 4456 &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white">
                        <i class="fas fa fa-thin fa-video"></i>
                    </h1>
                    <h6 class="text-white">
                        Channels
                        <span class="badge">&lpar; 451548M &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-success text-center">
                    ...
                    <h6 class="text-white">
                        Orders
                        <span class="badge">&lpar; 458 &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3" data-aos="zoom-in">
            <div class="card card-hover">
                <div class="box bg-warning text-center">
                    <h1 class="font-light text-white">
                        <i class="fas fa fa-thin fa-people-carry-box"></i>
                    </h1>
                    <h6 class="text-white">
                        Shipped
                        <span class="badge">&lpar; 45 &rpar;</span>
                    </h6>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex align-items-center">
                        <div>
                            <h4 class="card-title text-white">Site Analysis</h4>
                            <h5 class="card-subtitle">Overview of Latest Month</h5>
                        </div>
                    </div>
                    <div class="row">
                        <!-- column -->
                        <div class="col-lg-9" data-aos="zoon-in">
        ...
        <div class="col-lg-6" data-aos="zoom-in">
            <div class="card">
                ...
                <div class="comment-widgets scrollable">
                    ...
                    <div class="d-flex flex-row comment-row mt-0">
                        <div class="p-2"><img src="images/users/1.jpg" alt="user" width="50" class="rounded-circle">
                        </div>
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><img src="images/users/4.jpg" alt="user" width="50" class="rounded-circle">
                        </div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><img src="images/users/5.jpg" alt="user" width="50" class="rounded-circle">
                        </div>
                        <div class="comment-text w-100">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="todo-widget rounded scrollable" style="height:450px;">
                        <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
                            <li class="list-group-item todo-item" data-role="task">
                                ...
                                <ul class="list-style-none assignedto">
                                    <li class="assignee"><img class="rounded-circle" width="40" src="images/users/1.jpg"
                                            alt="user" data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Steave"></li>
                                    <li class="assignee"><img class="rounded-circle" width="40" src="images/users/2.jpg"
                                            alt="user" data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Jessica"></li>
                                    <li class="assignee"><img class="rounded-circle" width="40" src="images/users/3.jpg"
                                            alt="user" data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Priyanka"></li>
                                    <li class="assignee"><img class="rounded-circle" width="40" src="images/users/4.jpg"
                                            alt="user" data-toggle="tooltip" data-placement="top" title=""
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="chat-box scrollable" style="height:475px;">
                        ...
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li class="chat-item">
                                <div class="chat-img"><img src="images/users/1.jpg" alt="user">
                                </div>
                            ...
                            <!--chat Row -->
                            <li class="chat-item">
                                <div class="chat-img"><img src="images/users/2.jpg" alt="user">
                                </div>
                                <div class="chat-content">
                            ...
                            <!--chat Row -->
                            <li class="chat-item">
                                <div class="chat-img"><img src="images/users/3.jpg" alt="user">
                                </div>
                                <div class="chat-content">
                ...
                <div class="card-body border-top">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <a class="btn-circle btn-lg btn-cyan float-end text-white" href="#"><i
...
<footer class="footer text-center">
    All Rights Reserved by Matrix-admin. Designed and Developed by masum.org.it
</footer>
<!-- End footer -->
