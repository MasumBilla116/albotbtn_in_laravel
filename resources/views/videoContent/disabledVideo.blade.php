...
@section('title') {{"Disabled videos content"}} @endsection
@section('content')
...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title text-white text-shadow fs-2">Disabled video </h4>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center align-items-center">
                        <a href="#" class="btn btn-primary" data-aos="flip-left" data-aos-delay="500"
                            data-aos-duration="1000">Disabled</a>
                    </div>
                </td>
                <td>
                    <input type="checkbox" name="v1" class="form-check-input mt-3 checked-item" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="checkbox" name="v2" class="form-check-input mt-3 checked-item" />
                </td>
            </tr>
            <tr>
                <td>
