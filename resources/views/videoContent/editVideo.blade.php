    ...
    <table id="load-table"
        ...
        <tbody id="content" class="text-white">
            ...
            <tr>
                ...
                <td>
                    <a href="{{action('App\Http\Controllers\VideoContentController@updateVideoInfo',$row->t_id)}}">
                        {{$row->title}}
                    </a>
                </td>
                ...
                <td>
                    <div>
                        <button data-bs-toggle="modal" data-bs-target="#v{{736+$row->t_id+564}}w" type="button"
...
<!-- modal start -->
@foreach($tutorial as $row)
<div class="modal fade" id="v{{736+$row->t_id+564}}w">
